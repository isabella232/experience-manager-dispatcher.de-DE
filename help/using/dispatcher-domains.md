...
* Der Webserver verwendet Regeln zum Neuschreiben interner URLs, die Domänen-URLs in Cachepfade übersetzen. (Siehe [Der Webserver schreibt eingehende URLs neu](dispatcher-domains.md#main-pars-title-1))
